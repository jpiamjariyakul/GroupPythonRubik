...
def checkColor(	hsv_combined,
	...
	# TODO: See Bernard's file sent regarding comparing HSV
	...
	elif np.any(hsv_combined == hsv_blue):  return "B"
...
def verifyColor(	camera, face, row, column, c_combined,
	...
	if (row == 1) and (column == 1): 
		...
		if np.any(c_combined[coord_row][coord_col] != 0):
			...
			#print("Color at (" + str(camera) + ", " + str(coord_row) + ", " + str(coord_col) + "): " + str(color))
			#print("------------------------")
