...
def main():
    ...
    while(True):
        ...
        #boundary rules
        # Question: why are the masks added together?
        ...
        #result_final = result_white + result_red + result_orange + result_yellow + result_green + result_blue
